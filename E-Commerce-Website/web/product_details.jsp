...
<div class="container">
    <div class="row" style="margin-top: 40px">
        <div class="col-lg-6">
            <!--<img src="<%=img_name%>" width="550" height="400" alt="" style="margin-left: 120px"/>-->
            <div class="cart-container mb-2" style="width: 100%; height: 100%; background-image: url('<%=img_name%>'); background-size: cover; background-position: center;"></div>
        </div>
            ...
            <div class="box01">
                ...
                <form name="add_cart_form" action="ProductViewServlet" method="post" onsubmit="return checkCart()"> 
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" id="input" value="0" name="quantity" readonly class="border-0">
